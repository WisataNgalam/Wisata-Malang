...
<head>
	...
	<title>Gallery - Malang Travel Time</title>
	...
	<div class="container-fluid">
		<div class="single-head">
			<div class="col">
				...
				<h3>Beautifull Gallery Of Malang</h3>
				<p>Tangkap momen - momen indah dengan nuansa instagramable di Malang, Berikut adalah potret yang ditangkap oleh wisatawan</p>
			</div>
		</div>
	</div>
	<div class="row">
		<div class="column">
			<a href="img/Gallery/1.jpg" class="swipebox" title="Image by Instagram Explore Malang">
				<div class="wrapper">
			...
			<a href="img/Gallery/2.jpg" class="swipebox" title="Image by Instagram Explore Malang">
				<div class="wrapper">
					<div class="zoom-effect">
						<div class="image">
			...
			<a href="img/Gallery/3.jpg" class="swipebox" title="Image by Instagram Explore Malang">
				<div class="wrapper">
					<div class="zoom-effect">
						<div class="image">
			...
			<a href="img/Gallery/4.jpg" class="swipebox" title="Image by Instagram Explore Malang">
				<div class="wrapper">
					<div class="zoom-effect">
						<div class="image">
		...
		<div class="column">
			<a href="img/Gallery/5.jpg" class="swipebox" title="Image by Instagram Explore Malang">
				<div class="wrapper">
					<div class="zoom-effect">
						<div class="image">
			...
			<a href="img/Gallery/6.jpg" class="swipebox" title="Image by Instagram Explore Malang">
				<div class="wrapper">
					<div class="zoom-effect">
						<div class="image">
			...
			<a href="img/Gallery/7.jpg" class="swipebox" title="Image by Instagram Explore Malang">
				<div class="wrapper">
					<div class="zoom-effect">
						<div class="image">
			...
			<a href="img/Gallery/8.jpg" class="swipebox" title="Image by Instagram Explore Malang">
				<div class="wrapper">
					<div class="zoom-effect">
						<div class="image">
		...
		<div class="column">
			<a href="img/Gallery/10.jpg" class="swipebox" title="Image by Instagram Explore Malang">
				<div class="wrapper">
					<div class="zoom-effect">
						<div class="image">
			...
			<a href="img/Gallery/11.jpg" class="swipebox" title="Image by Instagram Explore Malang">
				<div class="wrapper">
					<div class="zoom-effect">
						<div class="image">
			...
			<a href="img/Gallery/12.jpg" class="swipebox" title="Image by Instagram Explore Malang">
				<div class="wrapper">
					<div class="zoom-effect">
						<div class="image">
		...
		<div class="column">
			<a href="img/Gallery/13.jpg" class="swipebox" title="Image by Instagram Explore Malang">
				<div class="wrapper">
					<div class="zoom-effect">
						<div class="image">
			...
			<a href="img/Gallery/14.jpg" class="swipebox" title="Image by Instagram Explore Malang">
				<div class="wrapper">
					<div class="zoom-effect">
						<div class="image">
			...
			<a href="img/Gallery/15.jpg" class="swipebox" title="Image by Instagram Explore Malang">
				<div class="wrapper">
					<div class="zoom-effect">
						<div class="image">
			...
			<a href="img/Gallery/19.jpg" class="swipebox" title="Image by Instagram Explore Malang">
				<div class="wrapper">
					<div class="zoom-effect">
						<div class="image">
